"""Field-flow test — is_nullable round-trips through the discovered_fields API."""


def test_discovered_fields_is_nullable_round_trips(client, admin_headers):
    body = {"name": "test"}
    body["is_nullable"] = True
    ...
    assert row.get("is_nullable") is True
