"""Field-flow test — first_seen_run_id (FK -> discovery_runs) round-trips through the datasets API."""


def test_datasets_first_seen_run_id_round_trips(client, admin_headers):
    parent = client.post(
