"""Field-flow test — dataset_id (FK -> datasets) round-trips through the discovered_fields API."""


def test_discovered_fields_dataset_id_round_trips(client, admin_headers):
    parent = client.post(
