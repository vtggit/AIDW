"""Field-flow test — source_id (FK -> sources) round-trips through the odata_service_configs API."""


def test_odata_service_configs_source_id_round_trips(client, admin_headers):
    parent = client.post(
    ...
    rejected = client.post(
        "/api/odata-service-configs", json=bogus, headers=admin_headers
    )
