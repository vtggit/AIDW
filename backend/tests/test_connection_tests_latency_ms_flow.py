"""Field-flow test — latency_ms round-trips through the connection_tests API."""


def test_connection_tests_latency_ms_round_trips(client, admin_headers):
    body = {"name": "test"}
    body["latency_ms"] = 7
