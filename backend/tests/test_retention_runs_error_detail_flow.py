"""Field-flow test — error_detail round-trips through the retention_runs API."""


def test_retention_runs_error_detail_round_trips(client, admin_headers):
    body = {"name": "test"}
    body["error_detail"] = "high"
    ...
    assert row.get("error_detail") == "high"
